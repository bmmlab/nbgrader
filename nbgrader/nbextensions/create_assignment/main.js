    ...
    var validate_ids = function() {
        ...
        for (i = 0; i < elems.length; i++) {
            ...
            if (!valid.test(label)) {
                ...
                modal_opts.body = "At least one cell has an invalid nbgrader ID (" + label + "). Cell IDs must contain at least one character, and may only contain letters, numbers, hyphens, and/or underscores.";
